...
def find_colmap_esim_rotation_translation():
    ...
    fit_points, (R,t) = affine_registration(colmap_trans, esim_trans)
    print((np.abs(fit_points - esim_trans)).sum())
    print((np.abs((colmap_trans@R.T + t) - esim_trans)).sum())

    return colmap_rot, esim_rot, R, t
